...
public class Text
{
    ...
    public const string AskStreet = nameof(AskStreet);
    public const string AskStreetInPlaceHolder = nameof(AskStreetInPlaceHolder);

    public const string Country = nameof(Country);
    public const string AskCountry = nameof(AskCountry);
    public const string AskCountryInPlaceHolder = nameof(AskCountryInPlaceHolder);

    public const string CountryCode = nameof(CountryCode);
    public const string AskCountryCode = nameof(AskCountryCode);
    public const string AskCountryCodeInPlaceHolder = nameof(AskCountryCodeInPlaceHolder);

    public const string Region = nameof(Region);
    public const string AskRegion = nameof(AskRegion);
    public const string AskRegionInPlaceHolder = nameof(AskRegionInPlaceHolder);
